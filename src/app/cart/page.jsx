      ...
      <MaxwidthContainer>
        ...
        <div className="space-y-4">
          {cartItems.map((item, index) => (
            <div key={index} className="flex items-center gap-4 p-4 border border-gray-300 rounded-lg">
              ...
              <div className="flex-1">
                <h3 className="font-semibold text-lg text-[#0E290E]">{item.title}</h3>
        ...
        <div className="mt-8 p-6 border border-gray-300 rounded-lg">
          <div className="flex justify-between items-center mb-4">
            ...
            <span className="text-xl font-bold text-[#0E290E]">{getCartItemsCount()}</span>
          </div>
